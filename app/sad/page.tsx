...
const page = () => {
  return (
    <div className='w-screen max-h-screen bg-cotton flex flex-row flex-wrap items-center justify-center overflow-hidden '>
      {/* <img src="/gifs/backhug.gif" alt="mochimochigif" /> */}
      ...
      {/* <img src="/gifs/kissss.gif" alt="mochimochigif" /> */}
