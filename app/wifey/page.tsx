  ...
  return (
    <div >
      <motion.div
        ...
        <p className='absolute text-7xl font-bold text-candy text-center max-lg:text-5xl p-5 top-50 '>THIS MIGHT BE US
        </p>
        <span className='absolute text-center text-xl text-candy/50 top-96'>Since you said YES</span>
      </motion.div>
    </div>
  )
}
